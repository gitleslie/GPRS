...
typedef enum
{
	...
	GAPP_OPT_CPU_ID,
	GAPP_OPT_MMAD_ID,
	GAPP_OPT_PIN47_IRQ_ID,
	GAPP_OPT_PIN3_IRQ_ID,
	GAPP_OPT_PIN40_IRQ_ID
}GAPP_OPTION_ID_T;
...
typedef enum
{
    ...
    GAPP_IO_5,//gpo
    GAPP_IO_6,//gpio
    GAPP_IO_7,//gpio not use in version 16
    GAPP_IO_8,//gpio not use in version 16
    GAPP_IO_9,//gpio
    GAPP_IO_10,//gpio
    GAPP_IO_11,//gpio
    GAPP_IO_12,//gpio
...
INT32  sys_period_timer_new(UINT32 ms,void (*fn)(void *arg),void *arg);
...
UINT32 sys_getCurrTimeInTicks(void);

UINT32 i2c_open(void);

void i2c_close(void);

UINT32 i2c_send_byte(UINT32 slaveAddr,UINT32 memAddr,UINT8 data);

UINT32 i2c_get_byte(UINT32 slaveAddr,UINT32 memAddr,UINT8* data);

UINT32 i2c_send_data(UINT32 slaveAddr,UINT32 memAddr,UINT8 *pData, UINT8 datalen);

UINT32 i2c_get_data(UINT32 slaveAddr,UINT32 memAddr,UINT8 *pData, UINT8 datalen);
#endif
